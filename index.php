...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="/img/kota\ gresik.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Pesan Melalui Resik & Rasakan Kuliner Gresik </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Pilih Tempatnya</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Pesan Makanannya</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Ambil Makanan Tersebut</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Kuliner Populer Bulan Ini Menurut User Resik</h2>
                    <p class="lead">Rasakan 6 Kuliner Top Menurut Pembelian User Di Bawah Ini!</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">Rp'.number_format($r['price'], 0, ',', '.').'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Pesan Sekarang</a> </div>
                                                </div>
                                            </div>
                                    </div>';                                      
                                }	
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Kita Menyediakan Semua Jenis Tipe Restoran</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Pilih Kulinermu</h3>
                                <p>Ayo Temukan Kuliner Yang Kamu Inginkan!</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Dapatkan Kuliner Kesukaanmu Dan Nikmati Rasanya! </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Semua Jenis Kuliner Ada Di Resik</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Rekomendasi Tempat Kuliner</h4> </div>
                    </div>
                    <div class="col-sm-8">
