                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Tempat Kuliner</span></a>
                            <ul aria-expanded="false" class="collapse">
								...
								<li><a href="add_category.php">Tambah Kuliner</a></li>
											...
											<?php
												...
												$query=mysqli_query($db,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="8"><center>Tidak Ada Pesanan</center></td>';
														}
													else
                                                                    ...
                                                                    while($rows=mysqli_fetch_array($query))
                                                                    {
                                                                        ...
                                                                        {
                                                                        ?>
                                                                        <td> <button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Tunggu Sebentar</button></td>
                                                                       <?php 
                                                                          }
                                                                        ...
                                                                        if($status=="closed")
                                                                            {
                                                                        ?>
                                                                        <td> <button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Selesai</button></td> 
                                                                        <?php 
                                                                        } 
                                                                        ?>
                                                                        <?php
