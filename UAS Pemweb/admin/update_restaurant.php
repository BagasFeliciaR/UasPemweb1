...
if(isset($_POST['submit']))        
{
		...
		{	
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																...
																<strong>Semua Bidang WAJIB Diisi!</strong>
															</div>';
				...
				$fname = $_FILES['file']['name'];
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Maksimal Ukuran Gambar Adalah 1024kb!</strong> Coba Gambar Yang Lain.
															</div>';
									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Perubahan Diupdate!</strong>.
															</div>';
					...
					elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Invalid Gambar!</strong> Jenis Gambar Yang Diperbolehkan Adalah png, jpg, Gif.
															</div>';
...
<head>
    ...
    <title>Update Tempat Kuliner</title>
                            ...
                            <div class="dropdown-menu animated zoomIn">
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        <h4 class="m-b-20">Gaya List</h4>
                             
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> LINK LAINNYA</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> LINK LAINNYA</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> LINK LAINNYA</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> LINK LAINNYA</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> LINK LAINNYA</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update Tempat Kuliner</h4>
                                       ...
                                       <?php $ssql ="select * from restaurant where rs_id='$_GET[res_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Bisnis E-mail</label>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];  ?>" placeholder="(+62)-555-5555">
                                                   </div>
                                            </div>
                         
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">website URL"(Bisa diganti dengan link google map)"</label>
                                                    <input type="text" name="url" class="form-control form-control-danger" value="<?php echo $row['url'];  ?>" placeholder="https://maps.app.goo.gl/4qTMkY9jpV26Bjpb8">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Buka Hari Apa Saja</label>
