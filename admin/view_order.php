                                        ...
                                        <tbody>
                                           <?php
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
															 <button type="button" class="btn btn-primary">Update Status Pesanan</button></a>
															 </center>
											 </td>
												...
												<td><strong>Nama:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
														<button type="button" class="btn btn-primary">Lihat Detail User</button></a>
                                            ...
                                            <tr>
                                                ...
                                                <td><center>Rp <?php echo number_format($rows['price'], 0, ',', '.'); ?></center></td>
                                            </tr>
											<tr>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Tunggu Sebentar</button></center></td>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																			<td>   <center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span>Dalam Proses</button></center></td> 
																			<?php
																				}
																			if($status=="closed")
																				{
																			?>
																			<td>  <center><button type="button" class="btn btn-primary" ><span  class="fa fa-check-circle" aria-hidden="true"></span> Selesai</button></center></td> 
																			<?php 
																			} 
																			?>
																			<?php
