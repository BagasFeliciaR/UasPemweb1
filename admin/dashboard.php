                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Tempat Kuliner</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">Semua Restoran</a></li>
								<li><a href="add_category.php">Tambah Kategori</a></li>
                                <li><a href="add_restaurant.php">Tambahk Tempat</a></li>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from restaurant";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Tempat Kuliner</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from res_category";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Kategori Tempat Kuliner</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'in process' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Pesanan Dalam Proses</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'closed' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Pesanan Yang Sudah Selesai</p>
                                </div>
                            </div>
                        </div>
                    </div>
