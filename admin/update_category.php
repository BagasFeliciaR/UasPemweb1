...
if(isset($_POST['submit'] ))
{
	...
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Berhasil!</strong> Diperbarui.</br></div>';
                            ...
                            <div class="dropdown-menu animated zoomIn">
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        <h4 class="m-b-20">Tipe List</h4>
                                
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Masukkan Link</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Masukkan Link</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Masukkan Link</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Masukkan Link</a></li>
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> Masukkan Link</a></li>
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Judul</h5> <span class="mail-desc">Ada Admin Baru</span> <span class="time">9:30</span>
                                                </div>
                                            </a>
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Judul</h5> <span class="mail-desc">Pengingat Kegiatan</span> <span class="time">9:10</span>
                                                </div>
                                            </a>
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Kategori Tempat Kuliner </h4>
                            </div>
                            <div class="card-body">
