				...
				$fname = $_FILES['file']['name'];
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Maksimal Gambar Adalah 1024kb!</strong> Coba Gambar Lain.
															</div>';
									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																 Kuliner Baru Telah Ditambahkan.
															</div>';
					...
					elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>invalid Tipe Gambar!</strong>Hanay Boleh Tipe png, jpg, Gif.
															</div>';
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Tempat Kuliner</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">SemuaTempat Kuliner</a></li>
                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Pilih Tempat Kuliner</label>
